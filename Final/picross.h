...
int bord_box_blanc(ligne L, liste ind_ligne, int longueur, liste *L_modif);         //fonction qui permet d'étaler le premier indice s'il y a une case noire au début de la ligne
